...
public class ContactController {
    ...
    public ResponseEntity<String> updateContact(
        ...
        try {
            ContactDTO existingContact = contactService.getCurrentContact(contactId);
            ...
            ContactDTO updatedContact = new ContactDTO(contactId, firstName, lastName, phoneNum, emailAddr, addr, existingContact.getDateCreated(), existingNote);
